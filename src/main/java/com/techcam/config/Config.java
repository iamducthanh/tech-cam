...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8080/vnp-pay/check-out/order"; // đây là link khi nó thanh toán thành công nó trả về link này,oke
    ...
    public static String hashAllFields(Map fields) {
        ...
        sb.append(com.techcam.config.Config.vnp_HashSecret);
