!function ($) {
    ...
    Datepicker.prototype = {
        constructor: Datepicker, _process_options: function (opts) {
            ...
            var cls = [], year = this.viewDate.getUTCFullYear(), month = this.viewDate.getUTCMonth(),
                currentDate = this.date.valueOf(), today = new Date;
            ...
            var d = new Date(this.viewDate), year = d.getUTCFullYear(), month = d.getUTCMonth(),
                ...
                currentDate = this.date && this.date.valueOf(), tooltip;
    ...
    var dates = $.fn.datepicker.dates = {
        en: {
            ...
            monthsShort: ["T1", "T2", "T3", "4", "Tháng 5", "Tháng 6", "Tháng 7", "Tháng 8", "Tháng 9", "Tháng 10", "Tháng 11", "Tháng 12"],
            today: "Today",
            clear: "Clear"
        }
    };
    var DPGlobal = {
        ...
        parseDate: function (date, format, language) {
            ...
            var parts = date && date.match(this.nonpunctuation) || [], date = new Date, parsed = {},
                setters_order = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"], setters_map = {
                    yyyy: function (d, v) {
