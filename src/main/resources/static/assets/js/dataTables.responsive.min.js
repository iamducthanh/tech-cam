(function(d) {
    "function" === typeof define && define.amd ?
        define(
            [
                "jquery",
                "https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/datatables.net",
            ],
            function(m) {
        ...
        "object" === typeof exports ?
            (module.exports = function(m, l) {
                ...
                if (!l || !l.fn.dataTable)
                    l =
                        require("https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/datatables.net")(
                            m,
                            l
                        ).$;
    ...
    function t(a, b, c) {
        ...
        if (n[e]) return n[e];
        for (
            var d = [], a = a.cell(b, c).node().childNodes, b = 0, c = a.length; b < c; b++
        )
            d.push(a[b]);
        return (n[e] = d);
    }
    ...
    var o = d.fn.dataTable,
        i = function(a, b) {
            if (!o.versionCheck ||
                !o.versionCheck(
                    "https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/1.10.10"
                )
            )
    ...
    d.extend(i.prototype, {
        _constructor: function() {
            ...
            d(m).on(
                "https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/resize.dtr orientationchange.dtr",
            ...
            b.on(
                "https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/destroy.dtr",
                function() {
                    b.off(".dtr");
            ...
            (a._detailsInit(),
                b.on(
                    "https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/column-visibility.dtr",
                    function() {
                ...
                b.on(
                    "https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/draw.dtr",
                    function() {
                        a._redrawChildren();
                    }
                ),
            ...
            b.on(
                "https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/column-reorder.dtr",
                function() {
                    a._classLogic();
                    a._resizeAuto();
                    a._resize(true);
            ...
            b.on(
                "https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/column-sizing.dtr",
                function() {
                    a._resizeAuto();
                    a._resize();
                }
            ...
            b.on(
                "https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/preXhr.dtr",
                function() {
                    var c = [];
            ...
            b.on(
                ...
                "https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/init.dtr",
                function(c) {
                    if (c.namespace === "dt") {
                        a._resizeAuto();
                        a._resize();
        ...
        _classLogic: function() {
            ...
            e.each(function(a, c) {
                for (
                    var e = a.className.split(" "), f = !1, i = 0, m = e.length; i < m; i++
                ) {
                    var l = e[i].trim();
                    if ("all" === l) {
                        f = !0;
        ...
        _detailsDisplay: function(a, b) {
            ...
            if (f && !1 !== f.type) {
                ...
                d(e.table().node()).triggerHandler(
                    "https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/responsive-display.dt", [e, a, g, b]
                );
            }
        },
        _detailsInit: function() {
            ...
            a._tabIndexes();
            d(b.table().body()).on(
                "https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/keyup.dtr",
                "td, th",
                function(a) {
            ...
            if (e !== q || null !== e)
                d(b.table().body()).on(
                    "https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/click.dtr mousedown.dtr mouseup.dtr",
        ...
        _resize: function(a) {
            ...
            (this._redrawChildren(),
                d(c.table().node()).trigger(
                    "https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/responsive-resize.dt", [c, this.s.current]
                ),
            ...
            return function(b, c, e) {
                if (c) d("div.dtr-modal-content").empty().append(e());
                    ...
                    var f = function() {
                            g.remove();
                            d(l).off(
                                "https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/keypress.dtr"
                            );
                        },
    ...
    d.fn.DataTable.Responsive = i;
    d(l).on(
        "https://themesbrand.com/foxia/layouts/blue/assets/libs/datatables.net-responsive/js/preInit.dt.dtr",
        function(a, b) {
            if (
                "dt" === a.namespace &&
