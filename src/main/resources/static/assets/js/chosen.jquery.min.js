    ...
    (e = (function() {
        ...
        return (
            ...
            (t.prototype.results_option_build = function(t) {
                var e, s, i, n, r, o, h;
                for (
                    e = "", h = 0, n = 0, r = (o = this.results_data).length; n < r &&
                    ((s = o[n]),
                        (i = ""),
                        "" !==
                        (i = s.group ?
                        ...
                        (s.selected && this.is_multiple ?
                            ...
                            s.selected &&
                            !this.is_multiple &&
                            this.single_set_selected_text(this.choice_label(s))), !(h >= this.max_shown_results)); n++
                );
                return e;
            }),
            (t.prototype.result_add_option = function(t) {
                ...
                return t.search_match && this.include_option_in_results(t) ?
                    ((e = []),
                        ...
                        e.push("active-result"), !t.disabled ||
                        (t.selected && this.is_multiple) ||
            ...
            (t.prototype.search_string_match = function(t, e) {
                var s;
                return (
                    (s = e.exec(t)), !this.search_contains &&
                    (null != s ? s[1] : void 0) &&
                    (s.index += 1),
                    s
                );
            ...
            (t.prototype.choices_click = function(t) {
                if (
                    (t.preventDefault(),
                        this.activate_field(), !this.results_showing && !this.is_disabled)
                )
        ...
        (s = (function(s) {
            ...
            return (
                ...
                (n.prototype.result_deselect = function(t) {
                    var e;
                    return (
                        (e = this.results_data[t]), !this.form_field.options[e.options_index].disabled &&
                        ((e.selected = !1),
